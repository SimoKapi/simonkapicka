...
//             for (const key of Object.keys(data)) {
//                 var rootKids = 0;
//                 objectChild = typeof data[key] === "object";
//                 if (objectChild) {rootKids = countRootKids(data[key]);} 
//                 else {rootKids = 1;}

//                 drawRectangle(context, colors["errorcolor"], colors["plantcolor"], colors["ptextcolor"], key, Math.round(rootKids/2) + rowOffset, level);
//                 if (objectChild) {
//                     dictList = Object.assign(dictList, data[key]);
//                     // drawLine(context, level, Math.round(countRootKids(data[key])/2) + rowOffset, level - 1, Math.round(rootKids/2) + rowOffset, colors["linecolor"]);
//                 }
//                 else {
//                     drawRectangle(context, colors["errorcolor"], colors["plantcolor"], colors["ptextcolor"], data[key], Math.round(rootKids/2) + rowOffset, 1);
//                     drawLine(context, level, Math.round(rootKids/2) + rowOffset, 1, Math.round(rootKids/2) + rowOffset, colors["linecolor"]);
//                 }
//                 positions.push(Math.round(rootKids/2) + rowOffset);
//                 rowOffset += rootKids;
//             }
//             if (objectChild === false) {return(positions)}
//             const newPositions = evaluateCategories(dictList, level-1);
//             for (const newPosition of newPositions) {
//                 for (const position of positions) {
//                     drawLine(context, level, Math.round(position), level - 1, newPosition, colors["linecolor"]);
//                 }
//             }
//         }
//     }
